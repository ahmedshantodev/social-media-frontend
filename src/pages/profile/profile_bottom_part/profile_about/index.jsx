...
const ProfileAbout = () => {
  ...
  return (
    <div className="w-full bg-white flex mb-10 rounded-[10px] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      <div className="w-[30%] border-r-2 border-primary-border/70 px-5 py-4">
        <p className="font-poppins text-xl font-medium">About</p>
      ...
      <div className="w-[70%] px-6 pt-5 pb-4">
        {selectedItem === "Overview" ? (
          ...
          <div>
            <p className="font-poppins font-medium text-secondary-text text-lg mb-3">
              Workplace :
            </p>
