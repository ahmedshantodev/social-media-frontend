    ...
    <div>
      ...
      <div className="flex gap-3 md:gap-4 lg:gap-6 mb-6 relative">
        <div
          ...
          className={
            selectedGender == "male"
              ? "w-2/4 border border-[#cacad8] font-poppins text-black rounded-[8px] pl-3 md:pl-4 flex gap-3 overflow-hidden cursor-pointer bg-[#e2e3f0]"
        ...
        <div
          ...
          className={
            selectedGender == "female"
              ? "w-2/4 border border-[#cacad8] font-poppins text-black rounded-[8px] pl-4 flex gap-3 overflow-hidden cursor-pointer bg-[#e2e3f0]"
        ...
        {error.gender && (
          <p className="font-inter text-[11px] lg:text-xs 2xl:text-[15px] text-[#e32626] absolute -bottom-[14px] md:-bottom-4 lg:-bottom-[15px] 2xl:-bottom-[18px] left-1">
            {error.gender}
          </p>
        )}
      </div>
