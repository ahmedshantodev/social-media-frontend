...
const StoriesPart = () => {
  ...
  return (
    <div className="w-full ml-5 mt-5 bg-[#f0f2f5] px-4 py-4 rounded-[10px] shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      <p className="font-inter font-semibold text-lg">Stories</p>

      <div className="mt-4 relative">
        <Swiper spaceBetween={12} slidesPerView={3}>
          <SwiperSlide>
            <div className="group relative w-full h-[250px] rounded-[10px] overflow-hidden cursor-pointer">
