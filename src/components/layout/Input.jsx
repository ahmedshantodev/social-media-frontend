...
const Input = ({
  ...
  return (
    <input
      ...
      className={`${className} ${
        error
          ? "border border-[#dc2626] font-poppins text-text_color placeholder:font-poppins placeholder:text-[#dc2626] focus:outline-1 focus:outline-[#dddcea] py-[17px] px-7 rounded-[8px]"
